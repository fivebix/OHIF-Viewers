...
function _load(rtDisplaySet, servicesManager, extensionManager, headers, createSegmentation = true) {
  ...
  if ((rtDisplaySet.loading || rtDisplaySet.isLoaded) && loadPromises[SOPInstanceUID] && cachedRTStructsSEG.has(rtDisplaySet.displaySetInstanceUID)) {
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"@ohif/extension-cornerstone-dicom-rt","version":"3.12.0","description":"DICOM RT read workflow","author":"OHIF","license":"MIT","main":"dist/ohif-extension-cornerstone-dicom-rt.umd.js","module":"src/index.tsx","files":["dist/**","public/**","README.md"],"publishConfig":{"access":"public"},"repository":"OHIF/Viewers","keywords":["ohif-extension"],"engines":{"node":">=14","npm":">=6","yarn":">=1.18.0"},"scripts":{"clean":"shx rm -rf dist","clean:deep":"yarn run clean && shx rm -rf node_modules","dev":"cross-env NODE_ENV=development webpack --config .webpack/webpack.dev.js --watch --output-pathinfo","dev:dicom-seg":"yarn run dev","build":"cross-env NODE_ENV=production webpack --config .webpack/webpack.prod.js","build:package-1":"yarn run build","start":"yarn run dev"},"peerDependencies":{"@ohif/core":"3.12.0","@ohif/extension-cornerstone":"3.12.0","@ohif/extension-default":"3.12.0","@ohif/i18n":"3.12.0","prop-types":"15.8.1","react":"18.3.1","react-dom":"18.3.1","react-i18next":"12.3.1","react-router":"6.30.3","react-router-dom":"6.30.3"},"dependencies":{"@babel/runtime":"7.28.2"}}');

"use strict";
(globalThis["webpackChunk"] = globalThis["webpackChunk"] || []).push([["node_modules_cornerstonejs_tools_dist_esm_enums_index_js-extensions_cornerstone-dynamic-volum-7497e5"],{
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"@ohif/extension-cornerstone-dynamic-volume","version":"3.11.1","description":"OHIF extension for 4D volumes data","author":"OHIF","license":"MIT","repository":"OHIF/Viewers","main":"dist/ohif-extension-cornerstone-dynamic-volume.umd.js","module":"src/index.ts","exports":{".":"./src/index.ts","./types":"./src/types/index.ts"},"files":["dist","README.md"],"publishConfig":{"access":"public"},"scripts":{"dev":"cross-env NODE_ENV=development webpack --config .webpack/webpack.dev.js --watch --output-pathinfo","build":"cross-env NODE_ENV=production webpack --config .webpack/webpack.prod.js","build:package":"yarn run build","clean":"shx rm -rf dist","clean:deep":"yarn run clean && shx rm -rf node_modules","start":"yarn run dev","test:unit":"jest --watchAll","test:unit:ci":"jest --ci --runInBand --collectCoverage --passWithNoTests"},"peerDependencies":{"@ohif/core":"3.11.1","@ohif/extension-cornerstone":"3.11.1","@ohif/extension-default":"3.11.1","@ohif/i18n":"3.11.1","@ohif/ui":"3.11.1","dcmjs":"0.43.1","dicom-parser":"1.8.21","hammerjs":"2.0.8","prop-types":"15.8.1","react":"18.3.1"},"dependencies":{"@babel/runtime":"7.28.2","@cornerstonejs/core":"4.5.13","@cornerstonejs/tools":"4.5.13","classnames":"2.5.1"}}');

/***/ })

}]);
//# sourceMappingURL=node_modules_cornerstonejs_tools_dist_esm_enums_index_js-extensions_cornerstone-dynamic-volum-7497e5.js.map
...
const _generateReport = (measurementData, additionalFindingTypes, options = {}) => {
  ...
  const report = MeasurementReport.generateReport(filteredToolState, _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData, options);
  const {
    dataset
  } = report;
...
function _checkIfCanAddMeasurementsToDisplaySet(srDisplaySet, newDisplaySet, dataSource, servicesManager) {
  ...
  for (let j = unloadedMeasurements.length - 1; j >= 0; j--) {
    ...
    if (is3DSR && is3DMeasurement && _measurementBelongsToDisplaySet({
      ...
      (0,_utils_addSRAnnotation__WEBPACK_IMPORTED_MODULE_4__["default"])({
        measurement,
        displaySet: newDisplaySet
      });
...
function init({
  ...
  (0,_utils_addToolInstance__WEBPACK_IMPORTED_MODULE_2__["default"])(_tools_toolNames__WEBPACK_IMPORTED_MODULE_3__["default"].DICOMSRDisplay, _tools_DICOMSRDisplayTool__WEBPACK_IMPORTED_MODULE_1__["default"]);
  ...
  (0,_utils_addToolInstance__WEBPACK_IMPORTED_MODULE_2__["default"])(_tools_toolNames__WEBPACK_IMPORTED_MODULE_3__["default"].SRRectangleROI, _cornerstonejs_tools__WEBPACK_IMPORTED_MODULE_0__.RectangleROITool);
  ...
  _cornerstonejs_tools__WEBPACK_IMPORTED_MODULE_0__.annotation.config.style.setToolGroupToolStyles('SRToolGroup', {
    [_tools_toolNames__WEBPACK_IMPORTED_MODULE_3__["default"].DICOMSRDisplay]: dashedLine,
    SRLength: dashedLine,
...
/* harmony import */ var _getRenderableData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getRenderableData */ "../../../extensions/cornerstone-dicom-sr/src/utils/getRenderableData.ts");
/* harmony import */ var _tools_toolNames__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../tools/toolNames */ "../../../extensions/cornerstone-dicom-sr/src/tools/toolNames.ts");
/* provided dependency */ var __react_refresh_utils__ = __webpack_require__(/*! ../../../node_modules/@pmmmwh/react-refresh-webpack-plugin/lib/runtime/RefreshUtils.js */ "../../../node_modules/@pmmmwh/react-refresh-webpack-plugin/lib/runtime/RefreshUtils.js");
__webpack_require__.$Refresh$.runtime = __webpack_require__(/*! ../../../node_modules/react-refresh/runtime.js */ "../../../node_modules/react-refresh/runtime.js");
...
function addSRAnnotation({
  ...
  let toolName = _tools_toolNames__WEBPACK_IMPORTED_MODULE_4__["default"].DICOMSRDisplay;
  ...
  const renderableData = measurement.coords.reduce((acc, coordProps) => {
    ...
    acc[coordProps.GraphicType].push((0,_getRenderableData__WEBPACK_IMPORTED_MODULE_3__["default"])({
      ...coordProps,
      imageId
    }));
    return acc;
  ...
  const SRAnnotation = {
    ...
    highlighted: false,
    isLocked: false,
    isPreview: toolName === _tools_toolNames__WEBPACK_IMPORTED_MODULE_4__["default"].DICOMSRDisplay,
    invalidated: false,
    metadata: {
      toolName,
      planeRestriction,
...
/* harmony export */ });
/* harmony import */ var _cornerstonejs_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @cornerstonejs/tools */ "../../../node_modules/@cornerstonejs/tools/dist/esm/index.js");
/* harmony import */ var _cornerstonejs_adapters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @cornerstonejs/adapters */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/index.js");
/* provided dependency */ var __react_refresh_utils__ = __webpack_require__(/*! ../../../node_modules/@pmmmwh/react-refresh-webpack-plugin/lib/runtime/RefreshUtils.js */ "../../../node_modules/@pmmmwh/react-refresh-webpack-plugin/lib/runtime/RefreshUtils.js");
__webpack_require__.$Refresh$.runtime = __webpack_require__(/*! ../../../node_modules/react-refresh/runtime.js */ "../../../node_modules/react-refresh/runtime.js");
...
function getFilteredCornerstoneToolState(measurementData, additionalFindingTypes) {
  ...
  function addToFilteredToolState(annotation, toolType) {
    const imageId = annotation.metadata?.referencedImageId ?? _cornerstonejs_adapters__WEBPACK_IMPORTED_MODULE_1__.NO_IMAGE_ID;
  ...
  const annotationManager = _cornerstonejs_tools__WEBPACK_IMPORTED_MODULE_0__.annotation.state.getAnnotationManager();
...
/* harmony import */ var _getLabelFromDCMJSImportedToolData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getLabelFromDCMJSImportedToolData */ "../../../extensions/cornerstone-dicom-sr/src/utils/getLabelFromDCMJSImportedToolData.js");
...
/* harmony import */ var _ohif_extension_cornerstone__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ohif/extension-cornerstone */ "../../../extensions/cornerstone/src/index.tsx");
/* provided dependency */ var __react_refresh_utils__ = __webpack_require__(/*! ../../../node_modules/@pmmmwh/react-refresh-webpack-plugin/lib/runtime/RefreshUtils.js */ "../../../node_modules/@pmmmwh/react-refresh-webpack-plugin/lib/runtime/RefreshUtils.js");
__webpack_require__.$Refresh$.runtime = __webpack_require__(/*! ../../../node_modules/react-refresh/runtime.js */ "../../../node_modules/react-refresh/runtime.js");
...
const {
  locking
} = _cornerstonejs_tools__WEBPACK_IMPORTED_MODULE_5__.annotation;
const {
  guid
...
const {
  CORNERSTONE_3D_TOOLS_SOURCE_NAME,
  CORNERSTONE_3D_TOOLS_SOURCE_VERSION
} = _ohif_extension_cornerstone__WEBPACK_IMPORTED_MODULE_6__.Enums;
...
function hydrateStructuredReport({
  ...
  const instance = _ohif_core__WEBPACK_IMPORTED_MODULE_1__.DicomMetadataStore.getInstance(studyUID, seriesUID, sopUID);
  ...
  sopInstanceUIDToImageId, _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData);
  ...
  Object.keys(hydratableMeasurementsInSR).forEach(annotationType => {
    ...
    toolDataForAnnotationType.forEach(toolData => {
      ...
      _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.utilities.updatePlaneRestriction(annotation.data.handles.points, annotation.metadata);
      const source = measurementService.getSource(CORNERSTONE_3D_TOOLS_SOURCE_NAME, CORNERSTONE_3D_TOOLS_SOURCE_VERSION);
      annotation.data.label = (0,_getLabelFromDCMJSImportedToolData__WEBPACK_IMPORTED_MODULE_3__["default"])(toolData);
...
function getReferenceData3D(toolData, servicesManager) {
  ...
  _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.utilities.updatePlaneRestriction(points, viewReference);
...
function centerOf(points) {
  ...
  const center = gl_matrix__WEBPACK_IMPORTED_MODULE_2__.vec3.create();
  for (const point of points) {
    gl_matrix__WEBPACK_IMPORTED_MODULE_2__.vec3.scaleAndAdd(center, center, point, scale);
  }
  return center;
}
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"@ohif/extension-cornerstone-dicom-sr","version":"3.12.0","description":"OHIF extension for an SR Cornerstone Viewport","author":"OHIF","license":"MIT","repository":"OHIF/Viewers","main":"dist/ohif-extension-cornerstone-dicom-sr.umd.js","module":"src/index.tsx","engines":{"node":">=14","npm":">=6","yarn":">=1.16.0"},"files":["dist","README.md"],"publishConfig":{"access":"public"},"keywords":["ohif-extension"],"scripts":{"clean":"shx rm -rf dist","clean:deep":"yarn run clean && shx rm -rf node_modules","dev":"cross-env NODE_ENV=development webpack --config .webpack/webpack.dev.js --watch --output-pathinfo","dev:cornerstone":"yarn run dev","build":"cross-env NODE_ENV=production webpack --config .webpack/webpack.prod.js","build:package-1":"yarn run build","start":"yarn run dev","test:unit":"jest --watchAll","test:unit:ci":"jest --ci --runInBand --collectCoverage --passWithNoTests"},"peerDependencies":{"@ohif/core":"3.12.0","@ohif/extension-cornerstone":"3.12.0","@ohif/extension-measurement-tracking":"3.12.0","@ohif/ui":"3.12.0","dcmjs":"0.49.4","dicom-parser":"1.8.21","hammerjs":"2.0.8","prop-types":"15.8.1","react":"18.3.1"},"dependencies":{"@babel/runtime":"7.28.2","@cornerstonejs/adapters":"4.15.29","@cornerstonejs/core":"4.15.29","@cornerstonejs/tools":"4.15.29","classnames":"2.5.1"}}');

...
function init({
  ...
  measurementService.addMapping(csTools3DVer1MeasurementSource, 'SRSCOORD3DPoint', POINT, _utils_SRSCOOR3DProbeMapper__WEBPACK_IMPORTED_MODULE_4__["default"].toAnnotation, _utils_SRSCOOR3DProbeMapper__WEBPACK_IMPORTED_MODULE_4__["default"].toMeasurement.bind(null, {
    servicesManager
  }));
...
function addSRAnnotation(measurement, imageId, frameNumber) {
  ...
  if (valueType === 'SCOORD3D') {
    ...
    if (!adapter) {
      toolName = _tools_toolNames__WEBPACK_IMPORTED_MODULE_4__["default"].SRSCOORD3DPoint;
    }
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"@ohif/extension-cornerstone-dicom-sr","version":"3.11.1","description":"OHIF extension for an SR Cornerstone Viewport","author":"OHIF","license":"MIT","repository":"OHIF/Viewers","main":"dist/ohif-extension-cornerstone-dicom-sr.umd.js","module":"src/index.tsx","engines":{"node":">=14","npm":">=6","yarn":">=1.16.0"},"files":["dist","README.md"],"publishConfig":{"access":"public"},"keywords":["ohif-extension"],"scripts":{"clean":"shx rm -rf dist","clean:deep":"yarn run clean && shx rm -rf node_modules","dev":"cross-env NODE_ENV=development webpack --config .webpack/webpack.dev.js --watch --output-pathinfo","dev:cornerstone":"yarn run dev","build":"cross-env NODE_ENV=production webpack --config .webpack/webpack.prod.js","build:package-1":"yarn run build","start":"yarn run dev","test:unit":"jest --watchAll","test:unit:ci":"jest --ci --runInBand --collectCoverage --passWithNoTests"},"peerDependencies":{"@ohif/core":"3.11.1","@ohif/extension-cornerstone":"3.11.1","@ohif/extension-measurement-tracking":"3.11.1","@ohif/ui":"3.11.1","dcmjs":"0.43.1","dicom-parser":"1.8.21","hammerjs":"2.0.8","prop-types":"15.8.1","react":"18.3.1"},"dependencies":{"@babel/runtime":"7.28.2","@cornerstonejs/adapters":"4.5.13","@cornerstonejs/core":"4.5.13","@cornerstonejs/tools":"4.5.13","classnames":"2.5.1"}}');

"use strict";
(globalThis["webpackChunk"] = globalThis["webpackChunk"] || []).push([["vendors-node_modules_xstate_react_es_index_js"],{
...
/* harmony import */ var _useInterpret__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./useInterpret */ "../../../node_modules/@xstate/react/es/useInterpret.js");
...
/* harmony import */ var _useSelector__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./useSelector */ "../../../node_modules/@xstate/react/es/useSelector.js");
...
function createActorContext(machine, interpreterOptions, observerOrListener) {
    var ReactContext = react__WEBPACK_IMPORTED_MODULE_0__.createContext(null);
    ...
    function Provider(_a) {
        ...
        var actor = (0,_useInterpret__WEBPACK_IMPORTED_MODULE_1__.useInterpret)(providedMachine, __assign(__assign({}, interpreterOptions), options), observerOrListener);
        return react__WEBPACK_IMPORTED_MODULE_0__.createElement(OriginalProvider, { value: actor }, children);
    }
    Provider.displayName = "ActorProvider(".concat(machine.id, ")");
    function useContext() {
        var actor = react__WEBPACK_IMPORTED_MODULE_0__.useContext(ReactContext);
        if (!actor) {
    ...
    function useActor() {
        ...
        return (0,_useActor__WEBPACK_IMPORTED_MODULE_2__.useActor)(actor);
    }
    function useSelector(selector, compare) {
        var actor = useContext();
        return (0,_useSelector__WEBPACK_IMPORTED_MODULE_3__.useSelector)(actor, selector, compare);
    }
    return {
        Provider: Provider,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createActorContext: () => (/* reexport safe */ _createActorContext__WEBPACK_IMPORTED_MODULE_6__.createActorContext),
/* harmony export */   shallowEqual: () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_5__.shallowEqual),
/* harmony export */   useActor: () => (/* reexport safe */ _useActor__WEBPACK_IMPORTED_MODULE_1__.useActor),
/* harmony export */   useInterpret: () => (/* reexport safe */ _useInterpret__WEBPACK_IMPORTED_MODULE_2__.useInterpret),
/* harmony export */   useMachine: () => (/* reexport safe */ _useMachine__WEBPACK_IMPORTED_MODULE_0__.useMachine),
/* harmony export */   useSelector: () => (/* reexport safe */ _useSelector__WEBPACK_IMPORTED_MODULE_3__.useSelector),
/* harmony export */   useSpawn: () => (/* reexport safe */ _useSpawn__WEBPACK_IMPORTED_MODULE_4__.useSpawn)
/* harmony export */ });
...
/* harmony import */ var _useInterpret__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./useInterpret */ "../../../node_modules/@xstate/react/es/useInterpret.js");
/* harmony import */ var _useSelector__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./useSelector */ "../../../node_modules/@xstate/react/es/useSelector.js");
/* harmony import */ var _useSpawn__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./useSpawn */ "../../../node_modules/@xstate/react/es/useSpawn.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils */ "../../../node_modules/@xstate/react/es/utils.js");
/* harmony import */ var _createActorContext__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./createActorContext */ "../../../node_modules/@xstate/react/es/createActorContext.js");
...
/* harmony import */ var use_sync_external_store_shim_with_selector__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! use-sync-external-store/shim/with-selector */ "../../../node_modules/use-sync-external-store/shim/with-selector.js");
...
function defaultGetSnapshot(actorRef) {
    return 'getSnapshot' in actorRef
        ? (0,_utils__WEBPACK_IMPORTED_MODULE_4__.isService)(actorRef)
            ? (0,_utils__WEBPACK_IMPORTED_MODULE_4__.getServiceSnapshot)(actorRef)
...
function useActor(actorRef, getSnapshot) {
    ...
    var isEqual = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (prevState, nextState) {
        if ((0,_utils__WEBPACK_IMPORTED_MODULE_4__.isService)(actorRef)) {
            return (0,_utils__WEBPACK_IMPORTED_MODULE_4__.isInterpreterStateEqual)(actorRef, prevState, nextState);
        }
        return prevState === nextState;
    }, [actorRef]);
    var storeSnapshot = (0,use_sync_external_store_shim_with_selector__WEBPACK_IMPORTED_MODULE_3__.useSyncExternalStoreWithSelector)(subscribe, boundGetSnapshot, boundGetSnapshot, identity, isEqual);
    var send = (0,_useConstant__WEBPACK_IMPORTED_MODULE_2__["default"])(function () { return function () {
        var args = [];
...
function useIdleInterpreter(getMachine, options) {
    var machine = (0,_useConstant__WEBPACK_IMPORTED_MODULE_3__["default"])(function () {
    ...
    var service = (0,_useConstant__WEBPACK_IMPORTED_MODULE_3__["default"])(function () {
        var machineConfig = {
            context: context,
            guards: guards,
            actions: actions,
...
function useInterpret(getMachine) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
        ...
        var sub = service.subscribe((0,xstate__WEBPACK_IMPORTED_MODULE_2__.toObserver)(observerOrListener));
        return function () {
            sub.unsubscribe();
        };
    }, [observerOrListener]);
...
function useMachine(getMachine) {
    ...
    var service = (0,_useInterpret__WEBPACK_IMPORTED_MODULE_3__.useIdleInterpreter)(getMachine, options);
    var getSnapshot = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
        if (service.status === xstate__WEBPACK_IMPORTED_MODULE_2__.InterpreterStatus.NotStarted) {
            return (options.state
                ? xstate__WEBPACK_IMPORTED_MODULE_2__.State.create(options.state)
                : service.machine.initialState);
        }
        return service.getSnapshot();
    }, [service]);
    var isEqual = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (prevState, nextState) {
        return (0,_utils__WEBPACK_IMPORTED_MODULE_4__.isInterpreterStateEqual)(service, prevState, nextState);
    }, [service]);
    var subscribe = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (handleStoreChange) {
...
var defaultGetSnapshot = function (a, initialStateCacheRef) {
    if ((0,_utils__WEBPACK_IMPORTED_MODULE_3__.isService)(a)) {
        // A status of 0 = interpreter not started
        if (a.status === 0 && initialStateCacheRef.current) {
            return initialStateCacheRef.current;
        }
        var snapshot = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getServiceSnapshot)(a);
        initialStateCacheRef.current = a.status === 0 ? snapshot : null;
        return snapshot;
    }
    return (0,_useActor__WEBPACK_IMPORTED_MODULE_2__.isActorWithState)(a) ? a.state : undefined;
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useSpawn: () => (/* binding */ useSpawn)
/* harmony export */ });
...
function useSpawn(behavior) {
    var actorRef = (0,_useConstant__WEBPACK_IMPORTED_MODULE_1__["default"])(function () {
        return (0,xstate__WEBPACK_IMPORTED_MODULE_0__.spawnBehavior)(behavior);
    });
    return actorRef;
}
...
/* harmony import */ var _serviceScope_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./serviceScope.js */ "../../../node_modules/xstate/es/serviceScope.js");
...
/* harmony import */ var _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_virtual/_tslib.js */ "../../../node_modules/xstate/es/_virtual/_tslib.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils.js */ "../../../node_modules/xstate/es/utils.js");
/* harmony import */ var _State_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./State.js */ "../../../node_modules/xstate/es/State.js");
...
/* harmony import */ var _actions_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./actions.js */ "../../../node_modules/xstate/es/actions.js");
/* harmony import */ var _environment_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./environment.js */ "../../../node_modules/xstate/es/environment.js");
/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./constants.js */ "../../../node_modules/xstate/es/constants.js");
/* harmony import */ var _stateUtils_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./stateUtils.js */ "../../../node_modules/xstate/es/stateUtils.js");
/* harmony import */ var _Actor_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Actor.js */ "../../../node_modules/xstate/es/Actor.js");
/* harmony import */ var _invokeUtils_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./invokeUtils.js */ "../../../node_modules/xstate/es/invokeUtils.js");
...
/* harmony export */ });
/* harmony import */ var _virtual_tslib_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_virtual/_tslib.js */ "../../../node_modules/xstate/es/_virtual/_tslib.js");
/* harmony import */ var _types_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./types.js */ "../../../node_modules/xstate/es/types.js");
/* harmony import */ var _actionTypes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./actionTypes.js */ "../../../node_modules/xstate/es/actionTypes.js");
...
/* harmony import */ var _actions_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./actions.js */ "../../../node_modules/xstate/es/actions.js");
/* harmony import */ var _environment_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./environment.js */ "../../../node_modules/xstate/es/environment.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils.js */ "../../../node_modules/xstate/es/utils.js");
...
/* harmony import */ var _Actor_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Actor.js */ "../../../node_modules/xstate/es/Actor.js");
/* harmony import */ var _registry_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./registry.js */ "../../../node_modules/xstate/es/registry.js");
/* harmony import */ var _devTools_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./devTools.js */ "../../../node_modules/xstate/es/devTools.js");
/* harmony import */ var _serviceScope_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./serviceScope.js */ "../../../node_modules/xstate/es/serviceScope.js");
...
function toInvokeDefinition(invokeConfig) {
  return (0,_virtual_tslib_js__WEBPACK_IMPORTED_MODULE_0__.__assign)((0,_virtual_tslib_js__WEBPACK_IMPORTED_MODULE_0__.__assign)({
    type: _actionTypes_js__WEBPACK_IMPORTED_MODULE_2__.invoke
  }, invokeConfig), {
    toJSON: function () {
      invokeConfig.onDone;
...
/* harmony import */ var _types_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./types.js */ "../../../node_modules/xstate/es/types.js");
/* harmony import */ var _actionTypes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./actionTypes.js */ "../../../node_modules/xstate/es/actionTypes.js");
/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./constants.js */ "../../../node_modules/xstate/es/constants.js");
/* harmony import */ var _environment_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./environment.js */ "../../../node_modules/xstate/es/environment.js");
...
//# sourceMappingURL=vendors-node_modules_xstate_react_es_index_js.js.map